...
class InquiryController extends SecureController
{
	...
	function add($formdata = null)
	{
		if ($formdata) {
			...
			$fields = $this->fields = array("prospect_name", "prospect_phone", "event_date", "total_pax", "event_type", "platform", "assign_agent_name", "handled");
			...
			if (1) {
				...
				if ($rec_id) {
					if ($_SERVER['HTTP_REFERER'] == SITE_ADDR . 'inquiries/welcome.php') {
						header("Location: https://api.whatsapp.com/send?phone=$agentphone&text=Hi $agentname, I'm looking for my $event_type at $event_date and Total Pax of $total_pax persons.");
						exit;
					}
