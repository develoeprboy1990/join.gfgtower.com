...
<head>
  ...
  <title>Welcome to GFG Tower</title>
...
<body class="page-wrapper">
  <nav class="navbar navbar-expand-lg navbar-dark">
    <div class="container">
      <a class="navbar-brand" href="https://join.gfgtower.com/">
        <img class="img-responsive" src="images/gfg-tower-logo.jpg">
      </a>
  ...
  <div class="container">
    ...
    <div class="row main_row">
      ...
      <div class="col-sm-12 col-lg-12">
        <p>
        <h3>Hi Welcome to gfgtower!<br> Fill up the details and we will WhatsApp you shortly.</h3>
        </p>
        <form method="post" action="https://join.gfgtower.com/inquiry/add">
          ...
          <div>
            ...
            <div class="mb-3 row">
              <label for="prospect_name" class="col-sm-2 col-md-2 col-form-label">Total Pax:</label>
              <div class="col-sm-4 col-md-4">
                <input type="text" class="form-control" id="total_pax" name="total_pax" value="" required>
              </div>
            </div>
            <div class="mb-3 row">
              <label for="prospect_name" class="col-sm-2 col-md-2 col-form-label">Move In Date:</label>
              <div class="col-sm-4 col-md-4">
            ...
            <div class="mb-3 row">
              <label for="inputPassword" class="col-sm-2 col-md-2 col-form-label">Office Type:</label>
